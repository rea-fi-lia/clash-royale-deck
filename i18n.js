...
(function () {
  ...
  const DICT = {
    ...
    ja: {
      ...
      "decks.srcTop": "世界トップ{n}ランカー（{p}人分・{g}戦を集計）",
      "decks.srcTopNoSample": "世界トップ{n}ランカー",
      "decks.srcGenericSample": "世界上位ランカー{p}人分・{g}戦",
      ...
      "decks.descWin": "<b>{win}のランク戦</b>（合計{n}戦以上）から、<b>勝率と信頼度（試合数）を加味した順</b>に表示されます。3冠率＝勝った試合のうち3クラウンだった割合です。",
      "decks.descTrend": "<b>{win}</b>の中で、<b>使用人数が伸びた</b>デッキ順に表示されます。",
      "decks.descUsage": "<b>{win}</b>で、実際に使っている<b>人数と％が多い</b>デッキ順に表示されます。",
      "decks.descUsageN": "<b>{win}</b>で、延べ<b>{n}人</b>の内、実際に使っている<b>人数と％が多い</b>デッキ順に表示されます。",
      ...
      "crank.hintWin": "{win}の対戦結果から算出（{n}戦以上）。使用率は低いのに勝率が高い＝玄人好みの「隠れ強カード」。",
      "crank.hintRise": "{win}の中で、前半より直近側の使用率が伸びたカード順。",
    ...
    en: {
      ...
      "decks.srcTop": "the top {n} ranked players ({p} players · {g} battles)",
      "decks.srcTopNoSample": "the top {n} ranked players",
      "decks.srcGenericSample": "top players ({p} players · {g} battles)",
      ...
      "decks.nPeople": "{n} players",
      "集計期間": "Window",
      "直近1時間": "Last 1 hour",
      "直近1日": "Last 1 day",
      "過去3日": "Last 3 days",
      "統計目安7日": "Stats: last 7 days",
      "🧭 環境シェア（勝ち筋別）": "🧭 Meta share (by win condition)",
      ...
      "decks.descWin": "From <b>Ranked battles in {win}</b> ({n}+ games), sorted by <b>win rate weighted by reliability (sample size)</b>. 3-crown = share of wins that were 3-crown.",
      "decks.descTrend": "Within <b>{win}</b>, sorted by decks whose <b>player count grew</b>.",
      "decks.descUsage": "Sorted by decks <b>most used</b> (by player count and %) in <b>{win}</b>.",
      "decks.descUsageN": "Of <b>{n} entries</b> in <b>{win}</b>, sorted by decks <b>most used</b> (by count and %).",
      ...
      "card.add": "Add", "card.detail": "Card details",
      ...
      "crank.hintWin": "From battles in {win} ({n}+ games). Low usage but high win rate = a hidden gem.",
      "crank.hintRise": "Cards whose usage rose in the later part of {win}.",
    ...
    es: {
      ...
      "デッキ作成": "Crear mazo", "人気デッキ・デッキ開発": "Mazos populares", "支援・寄付": "Apoyar", "リクエスト・お問い合わせ": "Sugerencias y contacto",
    ...
    'pt-br': {
      ...
      "デッキ作成": "Criar deck", "人気デッキ・デッキ開発": "Decks populares", "支援・寄付": "Apoiar", "リクエスト・お問い合わせ": "Sugestões e contato",
    ...
    fr: {
      ...
      "デッキ作成": "Créer un deck", "人気デッキ・デッキ開発": "Decks populaires", "支援・寄付": "Soutenir", "リクエスト・お問い合わせ": "Suggestions et contact",
    ...
    de: {
      ...
      "デッキ作成": "Deck erstellen", "人気デッキ・デッキ開発": "Beliebte Decks", "支援・寄付": "Unterstützen", "リクエスト・お問い合わせ": "Feedback & Kontakt",
    ...
    ru: {
      ...
      "デッキ作成": "Создать колоду", "人気デッキ・デッキ開発": "Популярные колоды", "支援・寄付": "Поддержать", "リクエスト・お問い合わせ": "Предложения и контакты",
    ...
    ko: {
      ...
      "デッキ作成": "덱 만들기", "人気デッキ・デッキ開発": "인기 덱", "支援・寄付": "후원", "リクエスト・お問い合わせ": "요청 및 문의",
    ...
    'zh-cn': {
      ...
      "デッキ作成": "创建卡组", "人気デッキ・デッキ開発": "热门卡组", "支援・寄付": "支持", "リクエスト・お問い合わせ": "建议与联系",
    ...
    ar: {
      ...
      "デッキ作成": "إنشاء مجموعة", "人気デッキ・デッキ開発": "المجموعات الشائعة", "支援・寄付": "ادعم", "リクエスト・お問い合わせ": "اقتراحات وتواصل",
    ...
    tr: {
      ...
      "デッキ作成": "Deste oluştur", "人気デッキ・デッキ開発": "Popüler desteler", "支援・寄付": "Destek ol", "リクエスト・お問い合わせ": "Öneri ve iletişim",
    ...
    it: {
      ...
      "デッキ作成": "Crea mazzo", "人気デッキ・デッキ開発": "Mazzi popolari", "支援・寄付": "Sostieni", "リクエスト・お問い合わせ": "Suggerimenti e contatti",
    ...
    id: {
      ...
      "デッキ作成": "Buat dek", "人気デッキ・デッキ開発": "Dek populer", "支援・寄付": "Dukung", "リクエスト・お問い合わせ": "Saran & kontak",
    ...
    th: {
      ...
      "デッキ作成": "สร้างเด็ค", "人気デッキ・デッキ開発": "เด็คยอดนิยม", "支援・寄付": "สนับสนุน", "リクエスト・お問い合わせ": "คำขอและติดต่อ",
    ...
    vi: {
      ...
      "デッキ作成": "Tạo bộ bài", "人気デッキ・デッキ開発": "Bộ bài phổ biến", "支援・寄付": "Ủng hộ", "リクエスト・お問い合わせ": "Góp ý & liên hệ",
    ...
    'zh-tw': {
      ...
      "デッキ作成": "建立牌組", "人気デッキ・デッキ開発": "熱門牌組", "支援・寄付": "支持", "リクエスト・お問い合わせ": "建議與聯絡",
    ...
    fa: {
      ...
      "デッキ作成": "ساخت دک", "人気デッキ・デッキ開発": "دک‌های محبوب", "支援・寄付": "حمایت", "リクエスト・お問い合わせ": "پیشنهاد و تماس",
    ...
    nl: {
      "クラロワデッキ作成・診断ツール": "Clash Royale Deck Builder & Analyse",
      "デッキ作成": "Deck maken", "人気デッキ・デッキ開発": "Populaire decks", "支援・寄付": "Steunen", "リクエスト・お問い合わせ": "Suggesties & contact",
